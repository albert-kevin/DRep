...
**Parameter change**  
**Rationale for voting YES on "Update Plutus Cost Models"**  
I vote YES on Update Plutus Cost Models because this is a necessary technical parameter update for Protocol Version 11 and the van Rossem hard fork, enabling new Plutus primitives and improving consistency across Plutus V1, V2, and V3. This is not a treasury withdrawal; it is protocol maintenance grounded in benchmarking, Intersect Parameter Committee and Technical Steering Committee review, and prior enactment on SanchoNet, Preview, and Preprod. I recognize the concern that changes to some existing primitive costs take effect immediately and may create compatibility or transaction-builder issues, so this kind of update should be handled with clear technical communication. On balance, the evidence supports approving the update because accurate cost models are required for safe and useful Plutus evolution.
