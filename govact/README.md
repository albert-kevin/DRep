...
**New constitution**  
**Rationale for voting YES on cardano blockchain ecosystem constitution v2.0**  
...
**Treasury withdrawals**  
**Rationale for voting NO on "Cardano x Draper Dragon: Orion Fund"**  
...
**Treasury withdrawals**  
**Rationale for voting YES on "IO: Developer Experience Initiative"**  
...
**Treasury withdrawals**  
**Rationale for voting YES on "IO: Cardano Upgrades"**  
...
**Treasury withdrawals**  
**Rationale for voting YES on "Revised Cardano Summit 2026 Singapore"**  
...
**Treasury withdrawals**  
**Rationale for voting YES on "Cardano at TOKEN2049 Singapore 2026: Baseline Platinum Sponsorship"**  
...
**Treasury withdrawals**  
**Rationale for voting NO on "Cardano at TOKEN2049 Singapore 2026: Title Sponsorship Upgrade"**  
...
**ParameterChange**  
**Rationale for voting YES on "Reduce the committeeMinSize parameter from 7 to 5"**  
...
**Treasury withdrawals**  
**Rationale for voting YES on "IO: Hydra"**  
...
**InfoAction**  
**Rationale for voting NO on "Net Change Limit: Cardano Treasury (Epochs 613-713)"**  
...
**InfoAction**  
**Rationale for voting ABSTAIN on "Reforming Treasury Governance"**  
...
**Treasury withdrawals**  
**Rationale for voting NO on "Hardware Wallet Maintenance 2026"**  
...
**Treasury withdrawals**  
**Rationale for voting YES on "Withdraw 1,193,000 ada for Intersect Technical Steering Committee Support"**  
...
**Treasury withdrawals**  
**Rationale for voting YES on "Withdraw 120M ADA for AlphaGrowth's Cardano PRIME"**  
I vote YES on "Withdraw 120M ADA for AlphaGrowth's Cardano PRIME" as a conscious exception. Normally I would first fund a smaller research and planning phase, let the team show the results, and then let DReps vote separately on the large spending phase. Here I accept that the full 120M ADA is approved now, although an Operating Group can later decide whether roughly 90M goes to Phase 3; that group is an extra checkpoint, not a second DRep vote. I vote YES because Cardano needs a serious attempt to improve liquidity and adoption, and AlphaGrowth, Intersect, the phase checkpoint and return of unused funds make this a credible but risky attempt rather than a blank cheque. I expect clear public reporting on where the money goes, who benefits, what results last after incentives end, and when money must stop or return to the Treasury; I will not support an automatic follow-up budget.  


**gov_action1k02990lhw6wh74t7c6ufw3mqaek9ujtvyan99dj5qv5kvcs7pn8sgx6wlxf**  
**TreasuryWithdrawals**  
**Rationale for voting YES on "Intersect: Governance coordination and technical stewardship for the Cardano ecosystem"**  
...
**Treasury withdrawals**  
**Rationale for voting YES on "Blockfrost's transformation to not-for-profit"**  
...
**Treasury withdrawals**  
**Rationale for voting YES on "Withdraw 3,810,423 ada for Mithril Protocol"**  
...
**Treasury withdrawals**  
**Rationale for voting YES on "Cardano Builder DAO"**  
I vote YES on "Cardano Builder DAO" because Cardano needs a practical funding path for smaller established builders that can struggle to compete with large Treasury proposals, and this DAO has already completed two funding rounds, allocated funds across 34 proposals, and returned unused ADA. I see the model as a useful way to bring expert builder review and proposed DRep oversight closer to projects that can grow users, transactions, and TVL. The 20M ADA ask and delegation of funding decisions are significant risks, so I expect transparent recipient-level reporting, independent KPI verification, clear conflict disclosures, milestone gates, and a credible path to sustainability. This vote gives a proven but still evolving model a chance; it is not an automatic endorsement of recurring Treasury funding.

**gov_action1xk6yrz0tg72a2a63ytd99gapz46nlqlavckarleqt6nr8lyekd8qqp0ga3d**  
**Treasury withdrawals**  
**Rationale for voting NO on "Cardano Enterprise Adoption: Ticketing Platform"**  
...
**gov_action1mr0qdz2jmagvsch6r08fhqvq6vu8jakt4c8m9s7ea7z0p740vntqq4yjd6j**<br>
**Treasury withdrawals**<br>
**Rationale for voting YES on "Se7en Labs: Daedalus Wallet Maintenance and Improvements 2026-2027"**<br>
...
**gov_action1cpnqmlgpkz3dnwnm4spqzsmsp93y9mr4vqcm2ltcpqyyf7a7nszsq4h586r**<br>
**Treasury withdrawals**<br>
**Rationale for voting ABSTAIN on "Global Order Book connect Cardano DeFi to increase transaction"**<br>
...
**gov_action1mlvplrdk2t7eyclqeca77ppmfq3sghkr5hdppjqhdqdd573r7q6qqms7jwt**<br>
**Treasury withdrawals**<br>
...
**gov_action1w2w64uhelz0cg2np7m37hal905tdd7jpzm3fcyc3g7qvkwgfppgqqfsggt5**<br>
**NewCommittee**<br>
...
**gov_action1gxxltxr02p28a398p8c6t08xhpg82wkkv9xgwvuxkly48lhgf20sqlkl2l8**<br>
**Treasury withdrawals**<br>
**Rationale for voting NO on "Withdraw 11,787,063 ada for the OpenZeppelin Stack administered by Intersect"**<br>
I vote NO on Withdraw 11,787,063 ada for the OpenZeppelin Stack administered by Intersect. OpenZeppelin's record is real, but the treasury is asked to pay twice for the same public good: IO's already funded Developer Experience Initiative covers an OpenZeppelin-style Aiken contracts library, its public repo is still being updated, and this proposal publishes no gap analysis or division of labour. The core technical choice is deferred rather than resolved - the language is picked only after funding - so cost and interoperability cannot be judged. The ask is fixed in ada at a USD 0.16 reference rate while ada trades near USD 0.25, adding roughly USD 1M of converted value with no stated rule for the surplus or conversion fee, and the 500M Net Change Limit cited for compliance was rejected with 62.35% support. I expect a leaner, phased resubmission - library, security and standards first - that names the language, shows the gap and returns any surplus.

**gov_action1whncs25w727rj5tml7lmv48gnaf9mm66sdjds8s3l306et7xmkdsqzqd7s2**<br>
**ParameterChange**<br>
**Rationale for voting YES on "Reduce minPoolCost to 75 ada"**<br>
I vote YES on "Reduce minPoolCost to 75 ada". The fixed fee takes a much larger share of rewards from small pools, making them less attractive to delegators, while no operator is forced to lower its fee. The 2023 cut did not cause a market-wide race to the bottom, so 75 ada is a reasonable interim step that also reduces the reward for splitting stake across multiple pools. This is not a complete solution, and I still expect a proportional minimum margin and broader reform.
